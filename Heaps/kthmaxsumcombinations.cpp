...
// You have to find the ‘K’ maximum and valid sum combinations from all the possible sum combinations of the 
// arrays/lists ‘A’ and ‘B’.
...
// The first line of every test case contains two integers ‘N’ and ‘K’ denoting the length of the array/list and the 
// number of required sum combinations respectively. 
